function renderProductos() {
    ...
    if (cantidadTotalProductos() > 0) {
        ...
        productos.forEach(producto => {
            ...
            <td class="align-middle text-end"><img src="multimedia/trash3.svg" alt="Eliminar Producto" title="Eliminar Producto" width="24" onclick="eliminarProducto(${producto.id});"></td>
            </tr>`;
        });
